...
public class RegionsTest extends DrawingGUI {
	...
	public static void main(String[] args) { 
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				new RegionsTest("smiley", new RegionFinder(loadImage("/Users/rohithmandavilli/Desktop/Dartmouth/Classes/Fall 18/CS 10/smiley.png")), new Color(0, 0, 0));
				new RegionsTest("baker", new RegionFinder(loadImage("/Users/rohithmandavilli/Desktop/Dartmouth/Classes/Fall 18/CS 10/dartmouth-baker-tower.jpg")), new Color(130, 100, 100));
			}
		});
	}
}